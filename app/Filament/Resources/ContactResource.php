        ...
        return $form
            ->schema([
                Forms\Components\Select::make('doctor_id')
                    ...
                    ->preload()
                    ->label('Doctor Name'),
                Forms\Components\TextInput::make('message')->required()->label('Message'),
            ]);
    }
    ...
    public static function table(Table $table): Table
    {
        return $table
            ->columns([
                ...
                Tables\Columns\TextColumn::make('message')->toggleable(isToggledHiddenByDefault: false)->label('Message'),
