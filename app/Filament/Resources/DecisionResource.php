...
class DecisionResource extends Resource
{
    ...
    protected static ?string $navigationLabel = 'Medical decision';
    ...
    public static function form(Form $form): Form
    {
        return $form
            ...
            Forms\Components\Select::make('patient_id')
                ...
                ->preload()
                ->label('Patient Name'),
            Forms\Components\select::make('medical_decision')->label('Medical Decision')
                ->options([
                    'Admission' => 'Admission',
                    'Referral to higher center' => 'Referral to higher center',
