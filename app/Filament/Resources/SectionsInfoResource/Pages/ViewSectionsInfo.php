        ...
        return $schema
            ->components([
                ...
                Section::make('Description')
                    ->schema([
                        TextEntry::make('section_description')
                            ->label('')
                            ->columnSpanFull()
                            ->prose()
                            ->markdown()
                ...
                Section::make('Questions Breakdown')
                    ->schema([
                        Grid::make(4)
                            ->schema([
                                TextEntry::make('mandatory_questions')
                                    ->label('Mandatory')
                                ...
                                TextEntry::make('optional_questions')
                                    ->label('Optional')
                                ...
                                TextEntry::make('hidden_questions')
                                    ->label('Hidden')
                                ...
                                TextEntry::make('visible_questions')
                                    ->label('Visible')
                ...
                Section::make('Question Types')
                    ->schema([
                        Grid::make(4)
                            ->schema([
                                TextEntry::make('string_questions')
                                    ->label('String')
                                ...
                                TextEntry::make('select_questions')
                                    ->label('Select')
                                ...
                                TextEntry::make('multiple_questions')
                                    ->label('Multiple')
