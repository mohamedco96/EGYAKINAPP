...
use App\Http\Controllers\Api\V1\ConsultationController as V1ConsultationController;
...
class ConsultationController extends Controller
{
    ...
    public function __construct(V1ConsultationController $consultationController)
    {
