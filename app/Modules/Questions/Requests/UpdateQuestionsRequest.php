...
class UpdateQuestionsRequest extends FormRequest
{
    ...
    {
        return [
            'section_id' => 'sometimes|required|integer|exists:sections_infos,id',
            'section_name' => 'sometimes|required|string|max:255',
            'question' => 'sometimes|required|string',
            'values' => 'nullable|string',
            'type' => 'sometimes|required|string|in:text,number,select,multiple,checkbox,radio,date,time,datetime',
