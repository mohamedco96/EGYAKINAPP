        ...
        try {
            ...
            $content[] = [
                ...
                'text' => implode("\n", [
                    ...
                    '',
                    'Step 2 — before responding, check that you have captured these rows (they often appear at the TOP of the table and are easy to miss):',
                    '  • WBC / WBCs / TLC — the TOTAL white cell count (NOT a differential)',
                    '  • LYMPH No — absolute lymphocyte count',
                    '  • LYMPH% — lymphocyte percentage',
                    '  • Mono count / MONO No — absolute monocyte count',
                    '  • MONO% — monocyte percentage',
                    'If any of these are visible in the image but absent from your output so far, add them now.',
                    '',
                    'Also verify you captured these when present:',
                    '  MXD% | GRAN% | RBC | HGB | HCT | MCV | MCH | MCHC | RDW | PLT | MPV',
                    '  Baso count | Baso Per | Eos count | EO% | NEUT% | NEUT No | PCT | PDW | RDW-SD | RDW-CV | IG Count',
                    '',
                    'Rules:',
