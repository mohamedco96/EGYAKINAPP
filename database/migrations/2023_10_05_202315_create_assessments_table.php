...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('assessments', function (Blueprint $table) {
            ...
            $table->string('skin_examination_other_field')->nullable();
            $table->string('eye_examination')->nullable();
            $table->string('eye_examination_other_field')->nullable();
            $table->string('ear_examination')->nullable();
            $table->string('ear_examination_other_field')->nullable();
            $table->string('cardiac_examination')->nullable();
            $table->string('cardiac_examination_other_field')->nullable();
            $table->string('internal_jugular_vein')->nullable();
            $table->string('chest_examination')->nullable();
            $table->string('chest_examination_other_field')->nullable();
            $table->string('abdominal_examination')->nullable();
            $table->string('abdominal_examination_other_field')->nullable();
