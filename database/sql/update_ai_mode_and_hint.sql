-- =============================================================================
-- Update ai_mode and ai_hint for all sections
-- Run this on any environment: mysql -u root egyakin < update_ai_mode_and_hint.sql
-- =============================================================================

-- -----------------------------------------------------------------------------
-- ai_mode values
-- -----------------------------------------------------------------------------
UPDATE sections_infos SET ai_mode = CASE id
    WHEN 1  THEN 'voice'
    WHEN 2  THEN 'voice'
    WHEN 3  THEN 'voice'
    WHEN 4  THEN 'voice'
...
-- -----------------------------------------------------------------------------
-- ai_hint values — HTML hints shown to the doctor before recording
-- Sections with no voice mode (6, 9, 12, 13) get NULL
-- -----------------------------------------------------------------------------

-- Section 1: Patient History
UPDATE sections_infos SET ai_hint =
'<p><strong>Please mention the following:</strong></p>
<ul>
...
-- Section 4: Risk Factors for AKI
UPDATE sections_infos SET ai_hint =
'<p><strong>Please answer yes or no for each of the following:</strong></p>
<ul>
...
-- Section 5: Assessment of the Patient
UPDATE sections_infos SET ai_hint =
'<p><strong>Please mention the following:</strong></p>
<ul>
...
-- Section 6: Laboratory and radiology results (image mode)
UPDATE sections_infos SET ai_hint =
'<p><strong>Please upload a clear image of the lab report or radiology result. Make sure it includes:</strong></p>
<ul>
...
-- Section 9: no questions — no hint
UPDATE sections_infos SET ai_hint = NULL WHERE id = 9;

-- Section 10: CTS Patients (Cardiac Surgery)
UPDATE sections_infos SET ai_hint =
'<p><strong>Please mention the following:</strong></p>
<ul>
...
-- Section 11: GO Patients (Obstetric)
UPDATE sections_infos SET ai_hint =
'<p><strong>Please mention the following:</strong></p>
<ul>
...
-- Sections 12, 13: no questions — no hint
UPDATE sections_infos SET ai_hint = NULL WHERE id IN (12, 13);
