...
return [
    ...
    'analytics_subtitle' => 'Comprehensive Medical Data Analytics',
    'data_use_warning' => 'Data use is not permitted without our approval.',
    'data_use_warning_ar' => 'لا يُسمح باستخدام البيانات دون موافقتنا.',
    'real_time_insights' => 'Real-time Data Insights',
    ...
    'dm_htn_statistics' => 'DM vs HTN Statistics',
    'dialysis_percentage' => 'Dialysis Percentage',
    ...
    'no_diagnosis_data' => 'No diagnosis data available',
    'no_aki_cause_data' => 'No AKI cause data available',
    'no_outcome_data' => 'No outcome data available',
    'male' => 'Male',
    'female' => 'Female',
    'dm_yes' => 'DM (Yes)',
    'dm_no' => 'DM (No)',
